...
import com.vanta.vanta_auditor_api.utils.BackoffStrategy;
 ...
 */
@AutoConfiguration
@ConditionalOnClass(Vanta.class)
@EnableConfigurationProperties(VantaAuditorApiAutoConfigProperties.class)
public class VantaAuditorApiAutoConfig {

    /**
     * Constructor.
     */
    public VantaAuditorApiAutoConfig() {
    }
    ...
    @ConditionalOnProperty(prefix = "vantaauditorapi.retry-config", name = "strategy")
    public RetryConfig retryConfig(VantaAuditorApiAutoConfigProperties properties) {
        VantaAuditorApiAutoConfigProperties.RetryConfig retryProps = properties.getRetryConfig();
        
        if (RetryConfig.Strategy.BACKOFF.equals(retryProps.getStrategy())) {
            VantaAuditorApiAutoConfigProperties.RetryConfig.Backoff backoff = retryProps.getBackoff();
    ...
    @Bean
    @ConditionalOnMissingBean
    public HTTPClient httpClient(VantaAuditorApiAutoConfigProperties properties, Consumer<String> httpLogger) {
        VantaAuditorApiAutoConfigProperties.HttpClient httpClientProps = properties.getHttpClient();
    ...
    @Bean
    @ConditionalOnMissingBean
    @ConditionalOnPropertyPrefix(prefix = "vantaauditorapi.security")
    public SecuritySource securitySource(VantaAuditorApiAutoConfigProperties properties) {VantaAuditorApiAutoConfigProperties.Security securityProps = properties.getSecurity();
        com.vanta.vanta_auditor_api.models.components.Security.Builder securityBuilder = com.vanta.vanta_auditor_api.models.components.Security.builder();
    ...
    public SDKConfiguration sdkConfiguration(
            VantaAuditorApiAutoConfigProperties properties,
            HTTPClient httpClient,
            com.vanta.vanta_auditor_api.utils.Hooks hooks,
            com.vanta.vanta_auditor_api.utils.AsyncHooks asyncHooks,
     ...
     * @return A configured Vanta instance
     */
    @Bean
    @ConditionalOnMissingBean
    public Vanta vanta(SDKConfiguration sdkConfiguration) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public com.vanta.vanta_auditor_api.utils.AsyncHooks asyncHooks() {
        return new com.vanta.vanta_auditor_api.utils.AsyncHooks();
    }
    ...
    @Bean
    @ConditionalOnMissingBean
    public com.vanta.vanta_auditor_api.utils.Hooks hooks() {
        return new com.vanta.vanta_auditor_api.utils.Hooks();
    }
    /**
     * Creates a Audits sub-SDK bean if none exists.
     *
     * @param vanta the main SDK instance
     * @return A configured Audits instance
     */
    @Bean
    @ConditionalOnMissingBean
    public Audits audits(Vanta vanta) {
        return vanta.audits();
    }
    /**
     * Creates a Auditors sub-SDK bean if none exists.
     *
     * @param vanta the main SDK instance
     * @return A configured Auditors instance
     */
    @Bean
    @ConditionalOnMissingBean
    public Auditors auditors(Vanta vanta) {
        return vanta.auditors();
    }
     ...
     * @param vanta the main SDK instance
     * @param sdkConfiguration the configured SDKConfiguration bean
     * @return A configured AsyncVanta instance
     */
    @Bean
    @ConditionalOnMissingBean
    public AsyncVanta asyncVanta(Vanta vanta, SDKConfiguration sdkConfiguration) {
        return new AsyncVanta(vanta, sdkConfiguration);
    }
    /**
     * Creates an AsyncAudits sub-SDK bean if none exists.
     *
     * @param asyncVanta the async SDK instance
     * @return A configured AsyncAudits instance
     */
    @Bean
    @ConditionalOnMissingBean
    public AsyncAudits asyncAudits(AsyncVanta asyncVanta) {
        return asyncVanta.audits();
    }
    /**
     * Creates an AsyncAuditors sub-SDK bean if none exists.
     *
     * @param asyncVanta the async SDK instance
     * @return A configured AsyncAuditors instance
     */
    @Bean
    @ConditionalOnMissingBean
    public AsyncAuditors asyncAuditors(AsyncVanta asyncVanta) {
        return asyncVanta.auditors();
    }
}