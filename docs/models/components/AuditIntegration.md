...
| `tags`                                                                             | List\<*String*>                                                                    | :heavy_minus_sign:                                                                 | Integration category display names describing what data this integration provides. | [<br/>"Vulnerabilities",<br/>"Code changes"<br/>]                                  |
| `categories`                                                                       | List\<*String*>                                                                    | :heavy_minus_sign:                                                                 | Service category display names describing what the integration is used for.        | [<br/>"Version control systems"<br/>]                                              |