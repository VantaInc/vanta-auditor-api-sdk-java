package com.vanta.vanta_auditor_api.hooks;
...
public final class SDKHooks {
    ...
    public static void initialize(com.vanta.vanta_auditor_api.utils.Hooks hooks) {
    ...
    public static void initialize(com.vanta.vanta_auditor_api.utils.AsyncHooks asyncHooks) {
        ...
        // asyncHooks.registerAfterError(com.vanta.vanta_auditor_api.utils.HookAdapters.adapt(mySyncHook));
