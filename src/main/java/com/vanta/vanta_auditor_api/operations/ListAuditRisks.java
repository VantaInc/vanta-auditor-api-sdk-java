...
public class ListAuditRisks {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAuditRisksRequest, ListAuditRisksResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAuditRisksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAuditRisksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAuditRisksRequest request) {
        ...
        @Override
        public ListAuditRisksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAuditRisksResponse.Builder resBuilder =
                    ListAuditRisksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListAuditRisksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseAuditRisk(Utils.unmarshal(response, new TypeReference<PaginatedResponseAuditRisk>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAuditRisksRequest, com.vanta.vanta_auditor_api.models.operations.async.ListAuditRisksResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAuditRisksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAuditRisksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAuditRisksRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListAuditRisksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListAuditRisksResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListAuditRisksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListAuditRisksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseAuditRisk>() {})
                            .thenApply(res::withPaginatedResponseAuditRisk);
                } else {
