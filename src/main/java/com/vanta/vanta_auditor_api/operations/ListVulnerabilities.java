...
public class ListVulnerabilities {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListVulnerabilitiesRequest, ListVulnerabilitiesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListVulnerabilitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVulnerabilitiesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListVulnerabilitiesRequest request) {
        ...
        @Override
        public ListVulnerabilitiesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListVulnerabilitiesResponse.Builder resBuilder =
            ...
            ListVulnerabilitiesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseAuditorApiVulnerability(Utils.unmarshal(response, new TypeReference<PaginatedResponseAuditorApiVulnerability>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListVulnerabilitiesRequest, com.vanta.vanta_auditor_api.models.operations.async.ListVulnerabilitiesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListVulnerabilitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVulnerabilitiesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListVulnerabilitiesRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListVulnerabilitiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListVulnerabilitiesResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListVulnerabilitiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListVulnerabilitiesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseAuditorApiVulnerability>() {})
                            .thenApply(res::withPaginatedResponseAuditorApiVulnerability);
                } else {
