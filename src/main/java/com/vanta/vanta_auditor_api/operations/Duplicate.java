...
public class Duplicate {
    ...
    public static class Sync extends Base
            implements RequestOperation<DuplicateAuditRequest, DuplicateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DuplicateAuditRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<DuplicateAuditRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DuplicateAuditRequest request) {
        ...
        @Override
        public DuplicateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DuplicateResponse.Builder resBuilder =
                    DuplicateResponse
                            .builder()
            ...
            DuplicateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DuplicateAuditRequest, com.vanta.vanta_auditor_api.models.operations.async.DuplicateResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DuplicateAuditRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<DuplicateAuditRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DuplicateAuditRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.DuplicateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.DuplicateResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.DuplicateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.DuplicateResponse res = resBuilder.build();
