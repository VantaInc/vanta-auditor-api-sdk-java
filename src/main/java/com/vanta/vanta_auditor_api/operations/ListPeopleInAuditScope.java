...
public class ListPeopleInAuditScope {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPeopleInAuditScopeRequest, ListPeopleInAuditScopeResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPeopleInAuditScopeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPeopleInAuditScopeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPeopleInAuditScopeRequest request) {
        ...
        @Override
        public ListPeopleInAuditScopeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPeopleInAuditScopeResponse.Builder resBuilder =
                    ListPeopleInAuditScopeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListPeopleInAuditScopeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponsePerson(Utils.unmarshal(response, new TypeReference<PaginatedResponsePerson>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPeopleInAuditScopeRequest, com.vanta.vanta_auditor_api.models.operations.async.ListPeopleInAuditScopeResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPeopleInAuditScopeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPeopleInAuditScopeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPeopleInAuditScopeRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListPeopleInAuditScopeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListPeopleInAuditScopeResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListPeopleInAuditScopeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListPeopleInAuditScopeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponsePerson>() {})
                            .thenApply(res::withPaginatedResponsePerson);
                } else {
