...
public class GetCommentForInformationRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommentForInformationRequestRequest, GetCommentForInformationRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommentForInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommentForInformationRequestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommentForInformationRequestRequest request) {
        ...
        @Override
        public GetCommentForInformationRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommentForInformationRequestResponse.Builder resBuilder =
                    GetCommentForInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetCommentForInformationRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommentForInformationRequestRequest, com.vanta.vanta_auditor_api.models.operations.async.GetCommentForInformationRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommentForInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommentForInformationRequestRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommentForInformationRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.GetCommentForInformationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.GetCommentForInformationRequestResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.GetCommentForInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.GetCommentForInformationRequestResponse res = resBuilder.build();
