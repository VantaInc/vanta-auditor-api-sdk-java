...
public class GetAudit {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAuditRequest, GetAuditResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAuditRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAuditRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAuditRequest request) {
        ...
        @Override
        public GetAuditResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAuditResponse.Builder resBuilder =
                    GetAuditResponse
                            .builder()
            ...
            GetAuditResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAuditRequest, com.vanta.vanta_auditor_api.models.operations.async.GetAuditResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAuditRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAuditRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAuditRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.GetAuditResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.GetAuditResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.GetAuditResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.GetAuditResponse res = resBuilder.build();
