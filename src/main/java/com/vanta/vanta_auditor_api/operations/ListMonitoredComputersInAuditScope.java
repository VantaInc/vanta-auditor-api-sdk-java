...
public class ListMonitoredComputersInAuditScope {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMonitoredComputersInAuditScopeRequest, ListMonitoredComputersInAuditScopeResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListMonitoredComputersInAuditScopeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMonitoredComputersInAuditScopeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMonitoredComputersInAuditScopeRequest request) {
        ...
        @Override
        public ListMonitoredComputersInAuditScopeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMonitoredComputersInAuditScopeResponse.Builder resBuilder =
                    ListMonitoredComputersInAuditScopeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListMonitoredComputersInAuditScopeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseMonitoredComputer(Utils.unmarshal(response, new TypeReference<PaginatedResponseMonitoredComputer>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMonitoredComputersInAuditScopeRequest, com.vanta.vanta_auditor_api.models.operations.async.ListMonitoredComputersInAuditScopeResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMonitoredComputersInAuditScopeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMonitoredComputersInAuditScopeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMonitoredComputersInAuditScopeRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListMonitoredComputersInAuditScopeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListMonitoredComputersInAuditScopeResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListMonitoredComputersInAuditScopeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListMonitoredComputersInAuditScopeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseMonitoredComputer>() {})
                            .thenApply(res::withPaginatedResponseMonitoredComputer);
                } else {
