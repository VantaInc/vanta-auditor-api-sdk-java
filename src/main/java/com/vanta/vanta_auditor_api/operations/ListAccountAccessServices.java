...
public class ListAccountAccessServices {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAccountAccessServicesRequest, ListAccountAccessServicesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAccountAccessServicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAccountAccessServicesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountAccessServicesRequest request) {
        ...
        @Override
        public ListAccountAccessServicesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAccountAccessServicesResponse.Builder resBuilder =
                    ListAccountAccessServicesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListAccountAccessServicesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseAccountAccessService(Utils.unmarshal(response, new TypeReference<PaginatedResponseAccountAccessService>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAccountAccessServicesRequest, com.vanta.vanta_auditor_api.models.operations.async.ListAccountAccessServicesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAccountAccessServicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAccountAccessServicesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAccountAccessServicesRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListAccountAccessServicesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListAccountAccessServicesResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListAccountAccessServicesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListAccountAccessServicesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseAccountAccessService>() {})
                            .thenApply(res::withPaginatedResponseAccountAccessService);
                } else {
