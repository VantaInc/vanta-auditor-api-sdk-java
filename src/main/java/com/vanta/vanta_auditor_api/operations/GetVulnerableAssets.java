...
public class GetVulnerableAssets {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetVulnerableAssetsRequest, GetVulnerableAssetsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetVulnerableAssetsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetVulnerableAssetsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetVulnerableAssetsRequest request) {
        ...
        @Override
        public GetVulnerableAssetsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetVulnerableAssetsResponse.Builder resBuilder =
                    GetVulnerableAssetsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetVulnerableAssetsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseVulnerableAsset(Utils.unmarshal(response, new TypeReference<PaginatedResponseVulnerableAsset>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetVulnerableAssetsRequest, com.vanta.vanta_auditor_api.models.operations.async.GetVulnerableAssetsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetVulnerableAssetsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetVulnerableAssetsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetVulnerableAssetsRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.GetVulnerableAssetsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.GetVulnerableAssetsResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.GetVulnerableAssetsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.GetVulnerableAssetsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseVulnerableAsset>() {})
                            .thenApply(res::withPaginatedResponseVulnerableAsset);
                } else {
