...
public class GetAuditEvidenceComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAuditEvidenceCommentRequest, GetAuditEvidenceCommentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAuditEvidenceCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAuditEvidenceCommentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAuditEvidenceCommentRequest request) {
        ...
        @Override
        public GetAuditEvidenceCommentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAuditEvidenceCommentResponse.Builder resBuilder =
                    GetAuditEvidenceCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetAuditEvidenceCommentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAuditEvidenceCommentRequest, com.vanta.vanta_auditor_api.models.operations.async.GetAuditEvidenceCommentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAuditEvidenceCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAuditEvidenceCommentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAuditEvidenceCommentRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.GetAuditEvidenceCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.GetAuditEvidenceCommentResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.GetAuditEvidenceCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.GetAuditEvidenceCommentResponse res = resBuilder.build();
