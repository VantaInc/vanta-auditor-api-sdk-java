...
import com.vanta.vanta_auditor_api.models.components.AuditorControlAssessment;
...
public class UpsertAssessmentForControl {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpsertAssessmentForControlRequest, UpsertAssessmentForControlResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpsertAssessmentForControlRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpsertAssessmentForControlRequest.class, new TypeReference<UpsertAssessmentForControlRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpsertAssessmentForControlRequest request) {
        ...
        @Override
        public UpsertAssessmentForControlResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpsertAssessmentForControlResponse.Builder resBuilder =
                    UpsertAssessmentForControlResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            UpsertAssessmentForControlResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAuditorControlAssessment(Utils.unmarshal(response, new TypeReference<AuditorControlAssessment>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpsertAssessmentForControlRequest, com.vanta.vanta_auditor_api.models.operations.async.UpsertAssessmentForControlResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpsertAssessmentForControlRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpsertAssessmentForControlRequest.class, new TypeReference<UpsertAssessmentForControlRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpsertAssessmentForControlRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.UpsertAssessmentForControlResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.UpsertAssessmentForControlResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.UpsertAssessmentForControlResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.UpsertAssessmentForControlResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AuditorControlAssessment>() {})
                            .thenApply(res::withAuditorControlAssessment);
                } else {
