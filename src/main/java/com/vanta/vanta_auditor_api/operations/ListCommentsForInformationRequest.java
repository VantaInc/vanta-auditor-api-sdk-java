...
public class ListCommentsForInformationRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommentsForInformationRequestRequest, ListCommentsForInformationRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommentsForInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommentsForInformationRequestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommentsForInformationRequestRequest request) {
        ...
        @Override
        public ListCommentsForInformationRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommentsForInformationRequestResponse.Builder resBuilder =
                    ListCommentsForInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListCommentsForInformationRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseInformationRequestComment(Utils.unmarshal(response, new TypeReference<PaginatedResponseInformationRequestComment>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommentsForInformationRequestRequest, com.vanta.vanta_auditor_api.models.operations.async.ListCommentsForInformationRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommentsForInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommentsForInformationRequestRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommentsForInformationRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListCommentsForInformationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListCommentsForInformationRequestResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListCommentsForInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListCommentsForInformationRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseInformationRequestComment>() {})
                            .thenApply(res::withPaginatedResponseInformationRequestComment);
                } else {
