...
public class GetOrganizationInformation {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetOrganizationInformationRequest, GetOrganizationInformationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetOrganizationInformationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOrganizationInformationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOrganizationInformationRequest request) {
        ...
        @Override
        public GetOrganizationInformationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetOrganizationInformationResponse.Builder resBuilder =
            ...
            GetOrganizationInformationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAuditOrganizationInformation(Utils.unmarshal(response, new TypeReference<AuditOrganizationInformation>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetOrganizationInformationRequest, com.vanta.vanta_auditor_api.models.operations.async.GetOrganizationInformationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetOrganizationInformationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOrganizationInformationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetOrganizationInformationRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.GetOrganizationInformationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.GetOrganizationInformationResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.GetOrganizationInformationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.GetOrganizationInformationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AuditOrganizationInformation>() {})
                            .thenApply(res::withAuditOrganizationInformation);
                } else {
