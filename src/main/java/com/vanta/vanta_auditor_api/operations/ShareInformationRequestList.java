...
public class ShareInformationRequestList {
    ...
    public static class Sync extends Base
            implements RequestOperation<ShareInformationRequestListRequest, ShareInformationRequestListResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ShareInformationRequestListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ShareInformationRequestListRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ShareInformationRequestListRequest request) {
        ...
        @Override
        public ShareInformationRequestListResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ShareInformationRequestListResponse.Builder resBuilder =
                    ShareInformationRequestListResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ShareInformationRequestListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAudit(Utils.unmarshal(response, new TypeReference<Audit>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ShareInformationRequestListRequest, com.vanta.vanta_auditor_api.models.operations.async.ShareInformationRequestListResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ShareInformationRequestListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ShareInformationRequestListRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ShareInformationRequestListRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ShareInformationRequestListResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ShareInformationRequestListResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ShareInformationRequestListResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ShareInformationRequestListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Audit>() {})
                            .thenApply(res::withAudit);
                } else {
