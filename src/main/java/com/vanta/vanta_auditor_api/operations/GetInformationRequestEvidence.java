...
public class GetInformationRequestEvidence {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetInformationRequestEvidenceRequest, GetInformationRequestEvidenceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetInformationRequestEvidenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInformationRequestEvidenceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetInformationRequestEvidenceRequest request) {
        ...
        @Override
        public GetInformationRequestEvidenceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetInformationRequestEvidenceResponse.Builder resBuilder =
                    GetInformationRequestEvidenceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetInformationRequestEvidenceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInformationRequestEvidence(Utils.unmarshal(response, new TypeReference<InformationRequestEvidence>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetInformationRequestEvidenceRequest, com.vanta.vanta_auditor_api.models.operations.async.GetInformationRequestEvidenceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetInformationRequestEvidenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInformationRequestEvidenceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetInformationRequestEvidenceRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.GetInformationRequestEvidenceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.GetInformationRequestEvidenceResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.GetInformationRequestEvidenceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.GetInformationRequestEvidenceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<InformationRequestEvidence>() {})
                            .thenApply(res::withInformationRequestEvidence);
                } else {
