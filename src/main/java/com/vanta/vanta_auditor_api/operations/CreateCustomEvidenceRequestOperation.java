...
public class CreateCustomEvidenceRequestOperation implements RequestOperation<CreateCustomEvidenceRequestRequest, CreateCustomEvidenceRequestResponse> {
    ...
    public CreateCustomEvidenceRequestOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateCustomEvidenceRequestRequest request) throws Exception {
