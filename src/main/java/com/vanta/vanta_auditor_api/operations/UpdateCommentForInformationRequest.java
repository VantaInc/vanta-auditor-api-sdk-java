...
public class UpdateCommentForInformationRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommentForInformationRequestRequest, UpdateCommentForInformationRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCommentForInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommentForInformationRequestRequest.class, new TypeReference<UpdateCommentForInformationRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommentForInformationRequestRequest request) {
        ...
        @Override
        public UpdateCommentForInformationRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommentForInformationRequestResponse.Builder resBuilder =
                    UpdateCommentForInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            UpdateCommentForInformationRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInformationRequestComment(Utils.unmarshal(response, new TypeReference<InformationRequestComment>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommentForInformationRequestRequest, com.vanta.vanta_auditor_api.models.operations.async.UpdateCommentForInformationRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommentForInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommentForInformationRequestRequest.class, new TypeReference<UpdateCommentForInformationRequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommentForInformationRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.UpdateCommentForInformationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.UpdateCommentForInformationRequestResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.UpdateCommentForInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.UpdateCommentForInformationRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<InformationRequestComment>() {})
                            .thenApply(res::withInformationRequestComment);
                } else {
