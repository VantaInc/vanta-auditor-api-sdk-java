...
public class CreateAuditorOperation implements RequestOperation<AddAuditorInput, CreateAuditorResponse> {
    ...
    public CreateAuditorOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(AddAuditorInput request) throws Exception {
