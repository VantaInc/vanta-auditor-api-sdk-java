...
public class DeleteCommentForControl {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteCommentForControlRequest, DeleteCommentForControlResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteCommentForControlRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteCommentForControlRequest.class, new TypeReference<DeleteCommentForControlRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteCommentForControlRequest request) {
        ...
        @Override
        public DeleteCommentForControlResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteCommentForControlResponse.Builder resBuilder =
            ...
            DeleteCommentForControlResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteCommentForControlRequest, com.vanta.vanta_auditor_api.models.operations.async.DeleteCommentForControlResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteCommentForControlRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteCommentForControlRequest.class, new TypeReference<DeleteCommentForControlRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteCommentForControlRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.DeleteCommentForControlResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.DeleteCommentForControlResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.DeleteCommentForControlResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.DeleteCommentForControlResponse res = resBuilder.build();
