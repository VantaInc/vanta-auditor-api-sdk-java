...
public class ListInformationRequestActivity {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListInformationRequestActivityRequest, ListInformationRequestActivityResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListInformationRequestActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListInformationRequestActivityRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListInformationRequestActivityRequest request) {
        ...
        @Override
        public ListInformationRequestActivityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListInformationRequestActivityResponse.Builder resBuilder =
                    ListInformationRequestActivityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListInformationRequestActivityResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseInformationRequestActivityLog(Utils.unmarshal(response, new TypeReference<PaginatedResponseInformationRequestActivityLog>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListInformationRequestActivityRequest, com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestActivityResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListInformationRequestActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListInformationRequestActivityRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListInformationRequestActivityRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestActivityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestActivityResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestActivityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestActivityResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseInformationRequestActivityLog>() {})
                            .thenApply(res::withPaginatedResponseInformationRequestActivityLog);
                } else {
