...
import com.vanta.vanta_auditor_api.models.components.FrameworkCodes;
...
public class GetFrameworkCodes {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFrameworkCodesRequest, GetFrameworkCodesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetFrameworkCodesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFrameworkCodesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFrameworkCodesRequest request) {
        ...
        @Override
        public GetFrameworkCodesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFrameworkCodesResponse.Builder resBuilder =
                    GetFrameworkCodesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetFrameworkCodesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFrameworkCodes(Utils.unmarshal(response, new TypeReference<FrameworkCodes>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFrameworkCodesRequest, com.vanta.vanta_auditor_api.models.operations.async.GetFrameworkCodesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetFrameworkCodesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFrameworkCodesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFrameworkCodesRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.GetFrameworkCodesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.GetFrameworkCodesResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.GetFrameworkCodesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.GetFrameworkCodesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FrameworkCodes>() {})
                            .thenApply(res::withFrameworkCodes);
                } else {
