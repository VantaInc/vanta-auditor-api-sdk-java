...
public class CreateCommentForAuditEvidenceOperation implements RequestOperation<CreateCommentForAuditEvidenceRequest, CreateCommentForAuditEvidenceResponse> {
    ...
    public CreateCommentForAuditEvidenceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateCommentForAuditEvidenceRequest request) throws Exception {
