...
public class ListInformationRequestEvidence {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListInformationRequestEvidenceRequest, ListInformationRequestEvidenceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListInformationRequestEvidenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListInformationRequestEvidenceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListInformationRequestEvidenceRequest request) {
        ...
        @Override
        public ListInformationRequestEvidenceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListInformationRequestEvidenceResponse.Builder resBuilder =
                    ListInformationRequestEvidenceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListInformationRequestEvidenceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseInformationRequestEvidence(Utils.unmarshal(response, new TypeReference<PaginatedResponseInformationRequestEvidence>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListInformationRequestEvidenceRequest, com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestEvidenceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListInformationRequestEvidenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListInformationRequestEvidenceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListInformationRequestEvidenceRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestEvidenceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestEvidenceResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestEvidenceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestEvidenceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseInformationRequestEvidence>() {})
                            .thenApply(res::withPaginatedResponseInformationRequestEvidence);
                } else {
