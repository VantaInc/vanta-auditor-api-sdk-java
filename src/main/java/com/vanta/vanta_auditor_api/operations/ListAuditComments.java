...
public class ListAuditComments {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAuditCommentsRequest, ListAuditCommentsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAuditCommentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAuditCommentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAuditCommentsRequest request) {
        ...
        @Override
        public ListAuditCommentsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseComment(Utils.unmarshal(response, new TypeReference<PaginatedResponseComment>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAuditCommentsRequest, com.vanta.vanta_auditor_api.models.operations.async.ListAuditCommentsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAuditCommentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAuditCommentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAuditCommentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListAuditCommentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListAuditCommentsResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListAuditCommentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListAuditCommentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseComment>() {})
                            .thenApply(res::withPaginatedResponseComment);
                } else {
