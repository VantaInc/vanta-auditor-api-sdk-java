...
public class DeleteCommentForInformationRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteCommentForInformationRequestRequest, DeleteCommentForInformationRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteCommentForInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteCommentForInformationRequestRequest.class, new TypeReference<DeleteCommentForInformationRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteCommentForInformationRequestRequest request) {
        ...
        @Override
        public DeleteCommentForInformationRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteCommentForInformationRequestResponse.Builder resBuilder =
            ...
            DeleteCommentForInformationRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteCommentForInformationRequestRequest, com.vanta.vanta_auditor_api.models.operations.async.DeleteCommentForInformationRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteCommentForInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteCommentForInformationRequestRequest.class, new TypeReference<DeleteCommentForInformationRequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteCommentForInformationRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.DeleteCommentForInformationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.DeleteCommentForInformationRequestResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.DeleteCommentForInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.DeleteCommentForInformationRequestResponse res = resBuilder.build();
