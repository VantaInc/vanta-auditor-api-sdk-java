...
import com.vanta.vanta_auditor_api.models.components.PaginatedResponseVendor;
...
public class ListVendorsInAuditScope {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListVendorsInAuditScopeRequest, ListVendorsInAuditScopeResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListVendorsInAuditScopeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVendorsInAuditScopeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListVendorsInAuditScopeRequest request) {
        ...
        @Override
        public ListVendorsInAuditScopeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListVendorsInAuditScopeResponse.Builder resBuilder =
                    ListVendorsInAuditScopeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListVendorsInAuditScopeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseVendor(Utils.unmarshal(response, new TypeReference<PaginatedResponseVendor>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListVendorsInAuditScopeRequest, com.vanta.vanta_auditor_api.models.operations.async.ListVendorsInAuditScopeResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListVendorsInAuditScopeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVendorsInAuditScopeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListVendorsInAuditScopeRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListVendorsInAuditScopeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListVendorsInAuditScopeResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListVendorsInAuditScopeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListVendorsInAuditScopeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseVendor>() {})
                            .thenApply(res::withPaginatedResponseVendor);
                } else {
