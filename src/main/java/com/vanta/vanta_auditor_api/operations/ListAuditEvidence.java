...
public class ListAuditEvidence {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAuditEvidenceRequest, ListAuditEvidenceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAuditEvidenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAuditEvidenceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAuditEvidenceRequest request) {
        ...
        @Override
        public ListAuditEvidenceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAuditEvidenceResponse.Builder resBuilder =
            ...
            ListAuditEvidenceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseEvidence(Utils.unmarshal(response, new TypeReference<PaginatedResponseEvidence>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAuditEvidenceRequest, com.vanta.vanta_auditor_api.models.operations.async.ListAuditEvidenceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAuditEvidenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAuditEvidenceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAuditEvidenceRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListAuditEvidenceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListAuditEvidenceResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListAuditEvidenceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListAuditEvidenceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseEvidence>() {})
                            .thenApply(res::withPaginatedResponseEvidence);
                } else {
