...
public class ListAuditEvidence {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAuditEvidenceRequest request) throws Exception {
        ...
        @Override
        public ListAuditEvidenceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaginatedResponseEvidence out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaginatedResponseEvidence(out);
                    return res;
                } else {
