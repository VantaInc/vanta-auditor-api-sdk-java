...
public class ListCommentsForControl {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommentsForControlRequest, ListCommentsForControlResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommentsForControlRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommentsForControlRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommentsForControlRequest request) {
        ...
        @Override
        public ListCommentsForControlResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommentsForControlResponse.Builder resBuilder =
                    ListCommentsForControlResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListCommentsForControlResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseAuditControlComment(Utils.unmarshal(response, new TypeReference<PaginatedResponseAuditControlComment>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommentsForControlRequest, com.vanta.vanta_auditor_api.models.operations.async.ListCommentsForControlResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommentsForControlRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommentsForControlRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommentsForControlRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListCommentsForControlResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListCommentsForControlResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListCommentsForControlResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListCommentsForControlResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseAuditControlComment>() {})
                            .thenApply(res::withPaginatedResponseAuditControlComment);
                } else {
