...
public class ListCodeChanges {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCodeChangesRequest, ListCodeChangesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCodeChangesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCodeChangesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCodeChangesRequest request) {
        ...
        @Override
        public ListCodeChangesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCodeChangesResponse.Builder resBuilder =
                    ListCodeChangesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListCodeChangesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseCodeChange(Utils.unmarshal(response, new TypeReference<PaginatedResponseCodeChange>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCodeChangesRequest, com.vanta.vanta_auditor_api.models.operations.async.ListCodeChangesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCodeChangesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCodeChangesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCodeChangesRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListCodeChangesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListCodeChangesResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListCodeChangesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListCodeChangesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseCodeChange>() {})
                            .thenApply(res::withPaginatedResponseCodeChange);
                } else {
