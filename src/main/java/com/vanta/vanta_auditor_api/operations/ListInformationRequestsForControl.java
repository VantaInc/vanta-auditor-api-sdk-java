...
public class ListInformationRequestsForControl {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListInformationRequestsForControlRequest, ListInformationRequestsForControlResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListInformationRequestsForControlRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListInformationRequestsForControlRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListInformationRequestsForControlRequest request) {
        ...
        @Override
        public ListInformationRequestsForControlResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListInformationRequestsForControlResponse.Builder resBuilder =
                    ListInformationRequestsForControlResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListInformationRequestsForControlResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseInformationRequest(Utils.unmarshal(response, new TypeReference<PaginatedResponseInformationRequest>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListInformationRequestsForControlRequest, com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestsForControlResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListInformationRequestsForControlRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListInformationRequestsForControlRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListInformationRequestsForControlRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestsForControlResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestsForControlResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestsForControlResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestsForControlResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseInformationRequest>() {})
                            .thenApply(res::withPaginatedResponseInformationRequest);
                } else {
