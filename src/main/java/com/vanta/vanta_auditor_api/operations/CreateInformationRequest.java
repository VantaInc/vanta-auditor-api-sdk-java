...
public class CreateInformationRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateInformationRequestRequest, CreateInformationRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateInformationRequestRequest.class, new TypeReference<CreateInformationRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateInformationRequestRequest request) {
        ...
        @Override
        public CreateInformationRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateInformationRequestResponse.Builder resBuilder =
                    CreateInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateInformationRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateInformationRequestRequest, com.vanta.vanta_auditor_api.models.operations.async.CreateInformationRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateInformationRequestRequest.class, new TypeReference<CreateInformationRequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateInformationRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.CreateInformationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.CreateInformationRequestResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.CreateInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.CreateInformationRequestResponse res = resBuilder.build();
