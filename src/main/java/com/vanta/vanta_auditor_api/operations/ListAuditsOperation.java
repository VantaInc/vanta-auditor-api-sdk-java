...
public class ListAuditsOperation implements RequestOperation<ListAuditsRequest, ListAuditsResponse> {
    ...
    public ListAuditsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAuditsRequest request) throws Exception {
