...
public class ListAuditEvidenceUrls {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAuditEvidenceUrlsRequest request) throws Exception {
        ...
        @Override
        public ListAuditEvidenceUrlsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaginatedResponseEvidenceUrl out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaginatedResponseEvidenceUrl(out);
                    return res;
                } else {
