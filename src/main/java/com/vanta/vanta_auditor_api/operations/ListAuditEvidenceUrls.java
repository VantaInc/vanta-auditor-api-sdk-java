...
public class ListAuditEvidenceUrls {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAuditEvidenceUrlsRequest, ListAuditEvidenceUrlsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAuditEvidenceUrlsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAuditEvidenceUrlsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAuditEvidenceUrlsRequest request) {
        ...
        @Override
        public ListAuditEvidenceUrlsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAuditEvidenceUrlsResponse.Builder resBuilder =
            ...
            ListAuditEvidenceUrlsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseEvidenceUrl(Utils.unmarshal(response, new TypeReference<PaginatedResponseEvidenceUrl>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAuditEvidenceUrlsRequest, com.vanta.vanta_auditor_api.models.operations.async.ListAuditEvidenceUrlsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAuditEvidenceUrlsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAuditEvidenceUrlsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAuditEvidenceUrlsRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListAuditEvidenceUrlsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListAuditEvidenceUrlsResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListAuditEvidenceUrlsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListAuditEvidenceUrlsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseEvidenceUrl>() {})
                            .thenApply(res::withPaginatedResponseEvidenceUrl);
                } else {
