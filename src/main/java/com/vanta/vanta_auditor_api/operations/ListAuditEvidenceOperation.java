...
public class ListAuditEvidenceOperation implements RequestOperation<ListAuditEvidenceRequest, ListAuditEvidenceResponse> {
    ...
    public ListAuditEvidenceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAuditEvidenceRequest request) throws Exception {
