...
public class ListRiskSnapshots {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRiskSnapshotsRequest, ListRiskSnapshotsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListRiskSnapshotsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRiskSnapshotsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRiskSnapshotsRequest request) {
        ...
        @Override
        public ListRiskSnapshotsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListRiskSnapshotsResponse.Builder resBuilder =
                    ListRiskSnapshotsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListRiskSnapshotsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseRiskSnapshot(Utils.unmarshal(response, new TypeReference<PaginatedResponseRiskSnapshot>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListRiskSnapshotsRequest, com.vanta.vanta_auditor_api.models.operations.async.ListRiskSnapshotsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListRiskSnapshotsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRiskSnapshotsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRiskSnapshotsRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListRiskSnapshotsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListRiskSnapshotsResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListRiskSnapshotsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListRiskSnapshotsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseRiskSnapshot>() {})
                            .thenApply(res::withPaginatedResponseRiskSnapshot);
                } else {
