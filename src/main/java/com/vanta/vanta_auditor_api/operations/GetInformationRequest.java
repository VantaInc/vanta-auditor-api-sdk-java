...
public class GetInformationRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetInformationRequestRequest, GetInformationRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInformationRequestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetInformationRequestRequest request) {
        ...
        @Override
        public GetInformationRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetInformationRequestResponse.Builder resBuilder =
            ...
            GetInformationRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetInformationRequestRequest, com.vanta.vanta_auditor_api.models.operations.async.GetInformationRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInformationRequestRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetInformationRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.GetInformationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.GetInformationRequestResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.GetInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.GetInformationRequestResponse res = resBuilder.build();
