...
import com.vanta.vanta_auditor_api.models.components.InformationRequest;
...
public class AcceptInformationRequestEvidence {
    ...
    public static class Sync extends Base
            implements RequestOperation<AcceptInformationRequestEvidenceRequest, AcceptInformationRequestEvidenceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AcceptInformationRequestEvidenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AcceptInformationRequestEvidenceRequest.class, new TypeReference<AcceptInformationRequestEvidenceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AcceptInformationRequestEvidenceRequest request) {
        ...
        @Override
        public AcceptInformationRequestEvidenceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AcceptInformationRequestEvidenceResponse.Builder resBuilder =
                    AcceptInformationRequestEvidenceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            AcceptInformationRequestEvidenceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AcceptInformationRequestEvidenceRequest, com.vanta.vanta_auditor_api.models.operations.async.AcceptInformationRequestEvidenceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AcceptInformationRequestEvidenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AcceptInformationRequestEvidenceRequest.class, new TypeReference<AcceptInformationRequestEvidenceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AcceptInformationRequestEvidenceRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.AcceptInformationRequestEvidenceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.AcceptInformationRequestEvidenceResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.AcceptInformationRequestEvidenceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.AcceptInformationRequestEvidenceResponse res = resBuilder.build();
