...
public class CreateCommentForInformationRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommentForInformationRequestRequest, CreateCommentForInformationRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommentForInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommentForInformationRequestRequest.class, new TypeReference<CreateCommentForInformationRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommentForInformationRequestRequest request) {
        ...
        @Override
        public CreateCommentForInformationRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommentForInformationRequestResponse.Builder resBuilder =
                    CreateCommentForInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateCommentForInformationRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommentForInformationRequestRequest, com.vanta.vanta_auditor_api.models.operations.async.CreateCommentForInformationRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommentForInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommentForInformationRequestRequest.class, new TypeReference<CreateCommentForInformationRequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommentForInformationRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.CreateCommentForInformationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.CreateCommentForInformationRequestResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.CreateCommentForInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.CreateCommentForInformationRequestResponse res = resBuilder.build();
