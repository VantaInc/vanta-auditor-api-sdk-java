...
public class CreateCommentForAuditEvidence {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommentForAuditEvidenceRequest, CreateCommentForAuditEvidenceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommentForAuditEvidenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommentForAuditEvidenceRequest.class, new TypeReference<CreateCommentForAuditEvidenceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommentForAuditEvidenceRequest request) {
        ...
        @Override
        public CreateCommentForAuditEvidenceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommentForAuditEvidenceResponse.Builder resBuilder =
            ...
            CreateCommentForAuditEvidenceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withComment(Utils.unmarshal(response, new TypeReference<Comment>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommentForAuditEvidenceRequest, com.vanta.vanta_auditor_api.models.operations.async.CreateCommentForAuditEvidenceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommentForAuditEvidenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommentForAuditEvidenceRequest.class, new TypeReference<CreateCommentForAuditEvidenceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommentForAuditEvidenceRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.CreateCommentForAuditEvidenceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.CreateCommentForAuditEvidenceResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.CreateCommentForAuditEvidenceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.CreateCommentForAuditEvidenceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Comment>() {})
                            .thenApply(res::withComment);
                } else {
