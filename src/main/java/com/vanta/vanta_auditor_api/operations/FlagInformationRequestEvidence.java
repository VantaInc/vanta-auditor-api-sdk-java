...
public class FlagInformationRequestEvidence {
    ...
    public static class Sync extends Base
            implements RequestOperation<FlagInformationRequestEvidenceRequest, FlagInformationRequestEvidenceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(FlagInformationRequestEvidenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FlagInformationRequestEvidenceRequest.class, new TypeReference<FlagInformationRequestEvidenceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FlagInformationRequestEvidenceRequest request) {
        ...
        @Override
        public FlagInformationRequestEvidenceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FlagInformationRequestEvidenceResponse.Builder resBuilder =
                    FlagInformationRequestEvidenceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            FlagInformationRequestEvidenceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FlagInformationRequestEvidenceRequest, com.vanta.vanta_auditor_api.models.operations.async.FlagInformationRequestEvidenceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(FlagInformationRequestEvidenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FlagInformationRequestEvidenceRequest.class, new TypeReference<FlagInformationRequestEvidenceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FlagInformationRequestEvidenceRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.FlagInformationRequestEvidenceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.FlagInformationRequestEvidenceResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.FlagInformationRequestEvidenceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.FlagInformationRequestEvidenceResponse res = resBuilder.build();
