...
public class ListAuditIssues {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAuditIssuesRequest, ListAuditIssuesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAuditIssuesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAuditIssuesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAuditIssuesRequest request) {
        ...
        @Override
        public ListAuditIssuesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAuditIssuesResponse.Builder resBuilder =
                    ListAuditIssuesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListAuditIssuesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedIssueSnapshotItemsResponse(Utils.unmarshal(response, new TypeReference<PaginatedIssueSnapshotItemsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAuditIssuesRequest, com.vanta.vanta_auditor_api.models.operations.async.ListAuditIssuesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAuditIssuesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAuditIssuesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAuditIssuesRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListAuditIssuesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListAuditIssuesResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListAuditIssuesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListAuditIssuesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedIssueSnapshotItemsResponse>() {})
                            .thenApply(res::withPaginatedIssueSnapshotItemsResponse);
                } else {
