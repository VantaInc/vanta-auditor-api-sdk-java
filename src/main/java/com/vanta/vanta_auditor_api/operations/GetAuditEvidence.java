...
public class GetAuditEvidence {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAuditEvidenceRequest, GetAuditEvidenceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAuditEvidenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAuditEvidenceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAuditEvidenceRequest request) {
        ...
        @Override
        public GetAuditEvidenceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAuditEvidenceResponse.Builder resBuilder =
            ...
            GetAuditEvidenceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAuditEvidenceRequest, com.vanta.vanta_auditor_api.models.operations.async.GetAuditEvidenceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAuditEvidenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAuditEvidenceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAuditEvidenceRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.GetAuditEvidenceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.GetAuditEvidenceResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.GetAuditEvidenceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.GetAuditEvidenceResponse res = resBuilder.build();
