...
public class CreateAuditor {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddAuditorInput, CreateAuditorResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AddAuditorInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AddAuditorInput>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddAuditorInput request) {
        ...
        @Override
        public CreateAuditorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAuditorResponse.Builder resBuilder =
            ...
            CreateAuditorResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAuditor(Utils.unmarshal(response, new TypeReference<Auditor>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddAuditorInput, com.vanta.vanta_auditor_api.models.operations.async.CreateAuditorResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddAuditorInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AddAuditorInput>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddAuditorInput request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.CreateAuditorResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.CreateAuditorResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.CreateAuditorResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.CreateAuditorResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Auditor>() {})
                            .thenApply(res::withAuditor);
                } else {
