...
public class ListAuditSnapshots {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAuditSnapshotsRequest, ListAuditSnapshotsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAuditSnapshotsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAuditSnapshotsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAuditSnapshotsRequest request) {
        ...
        @Override
        public ListAuditSnapshotsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAuditSnapshotsResponse.Builder resBuilder =
                    ListAuditSnapshotsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListAuditSnapshotsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedIssueSnapshotMetadataResponse(Utils.unmarshal(response, new TypeReference<PaginatedIssueSnapshotMetadataResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAuditSnapshotsRequest, com.vanta.vanta_auditor_api.models.operations.async.ListAuditSnapshotsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAuditSnapshotsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAuditSnapshotsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAuditSnapshotsRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListAuditSnapshotsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListAuditSnapshotsResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListAuditSnapshotsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListAuditSnapshotsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedIssueSnapshotMetadataResponse>() {})
                            .thenApply(res::withPaginatedIssueSnapshotMetadataResponse);
                } else {
