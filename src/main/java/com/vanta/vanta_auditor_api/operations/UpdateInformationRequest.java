...
public class UpdateInformationRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateInformationRequestRequest, UpdateInformationRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateInformationRequestRequest.class, new TypeReference<UpdateInformationRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateInformationRequestRequest request) {
        ...
        @Override
        public UpdateInformationRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateInformationRequestResponse.Builder resBuilder =
                    UpdateInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            UpdateInformationRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateInformationRequestRequest, com.vanta.vanta_auditor_api.models.operations.async.UpdateInformationRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateInformationRequestRequest.class, new TypeReference<UpdateInformationRequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateInformationRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.UpdateInformationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.UpdateInformationRequestResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.UpdateInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.UpdateInformationRequestResponse res = resBuilder.build();
