...
public class ListIntegrations {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListIntegrationsRequest, ListIntegrationsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListIntegrationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListIntegrationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListIntegrationsRequest request) {
        ...
        @Override
        public ListIntegrationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListIntegrationsResponse.Builder resBuilder =
            ...
            ListIntegrationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseAuditIntegration(Utils.unmarshal(response, new TypeReference<PaginatedResponseAuditIntegration>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListIntegrationsRequest, com.vanta.vanta_auditor_api.models.operations.async.ListIntegrationsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListIntegrationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListIntegrationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListIntegrationsRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListIntegrationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListIntegrationsResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListIntegrationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListIntegrationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseAuditIntegration>() {})
                            .thenApply(res::withPaginatedResponseAuditIntegration);
                } else {
