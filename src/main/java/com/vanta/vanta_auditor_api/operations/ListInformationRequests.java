...
public class ListInformationRequests {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListInformationRequestsRequest, ListInformationRequestsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListInformationRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListInformationRequestsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListInformationRequestsRequest request) {
        ...
        @Override
        public ListInformationRequestsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListInformationRequestsResponse.Builder resBuilder =
                    ListInformationRequestsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListInformationRequestsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListInformationRequestsRequest, com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListInformationRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListInformationRequestsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListInformationRequestsRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestsResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListInformationRequestsResponse res = resBuilder.build();
