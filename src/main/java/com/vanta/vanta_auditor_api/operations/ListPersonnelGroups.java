...
public class ListPersonnelGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPersonnelGroupsRequest, ListPersonnelGroupsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPersonnelGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPersonnelGroupsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPersonnelGroupsRequest request) {
        ...
        @Override
        public ListPersonnelGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPersonnelGroupsResponse.Builder resBuilder =
                    ListPersonnelGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListPersonnelGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponsePersonnelGroup(Utils.unmarshal(response, new TypeReference<PaginatedResponsePersonnelGroup>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPersonnelGroupsRequest, com.vanta.vanta_auditor_api.models.operations.async.ListPersonnelGroupsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPersonnelGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPersonnelGroupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPersonnelGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListPersonnelGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListPersonnelGroupsResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListPersonnelGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListPersonnelGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponsePersonnelGroup>() {})
                            .thenApply(res::withPaginatedResponsePersonnelGroup);
                } else {
