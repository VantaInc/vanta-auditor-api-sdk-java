...
public class ListVendors {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListVendorsRequest, ListVendorsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListVendorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVendorsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListVendorsRequest request) {
        ...
        @Override
        public ListVendorsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListVendorsResponse.Builder resBuilder =
                    ListVendorsResponse
                            .builder()
            ...
            ListVendorsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseAuditVendor(Utils.unmarshal(response, new TypeReference<PaginatedResponseAuditVendor>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListVendorsRequest, com.vanta.vanta_auditor_api.models.operations.async.ListVendorsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListVendorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVendorsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListVendorsRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListVendorsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListVendorsResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListVendorsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListVendorsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseAuditVendor>() {})
                            .thenApply(res::withPaginatedResponseAuditVendor);
                } else {
