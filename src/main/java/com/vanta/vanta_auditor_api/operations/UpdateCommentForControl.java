...
public class UpdateCommentForControl {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommentForControlRequest, UpdateCommentForControlResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCommentForControlRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommentForControlRequest.class, new TypeReference<UpdateCommentForControlRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommentForControlRequest request) {
        ...
        @Override
        public UpdateCommentForControlResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommentForControlResponse.Builder resBuilder =
                    UpdateCommentForControlResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            UpdateCommentForControlResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommentForControlRequest, com.vanta.vanta_auditor_api.models.operations.async.UpdateCommentForControlResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommentForControlRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommentForControlRequest.class, new TypeReference<UpdateCommentForControlRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommentForControlRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.UpdateCommentForControlResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.UpdateCommentForControlResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.UpdateCommentForControlResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.UpdateCommentForControlResponse res = resBuilder.build();
