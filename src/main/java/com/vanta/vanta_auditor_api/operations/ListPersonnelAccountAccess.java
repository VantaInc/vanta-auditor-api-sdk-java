...
public class ListPersonnelAccountAccess {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPersonnelAccountAccessRequest, ListPersonnelAccountAccessResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPersonnelAccountAccessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPersonnelAccountAccessRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPersonnelAccountAccessRequest request) {
        ...
        @Override
        public ListPersonnelAccountAccessResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPersonnelAccountAccessResponse.Builder resBuilder =
                    ListPersonnelAccountAccessResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListPersonnelAccountAccessResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseAccountAccess(Utils.unmarshal(response, new TypeReference<PaginatedResponseAccountAccess>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPersonnelAccountAccessRequest, com.vanta.vanta_auditor_api.models.operations.async.ListPersonnelAccountAccessResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPersonnelAccountAccessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPersonnelAccountAccessRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPersonnelAccountAccessRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListPersonnelAccountAccessResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListPersonnelAccountAccessResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListPersonnelAccountAccessResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListPersonnelAccountAccessResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseAccountAccess>() {})
                            .thenApply(res::withPaginatedResponseAccountAccess);
                } else {
