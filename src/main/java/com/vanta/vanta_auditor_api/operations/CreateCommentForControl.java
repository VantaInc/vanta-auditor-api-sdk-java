...
import com.vanta.vanta_auditor_api.models.components.AuditControlComment;
...
public class CreateCommentForControl {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommentForControlRequest, CreateCommentForControlResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommentForControlRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommentForControlRequest.class, new TypeReference<CreateCommentForControlRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommentForControlRequest request) {
        ...
        @Override
        public CreateCommentForControlResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommentForControlResponse.Builder resBuilder =
                    CreateCommentForControlResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateCommentForControlResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAuditControlComment(Utils.unmarshal(response, new TypeReference<AuditControlComment>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommentForControlRequest, com.vanta.vanta_auditor_api.models.operations.async.CreateCommentForControlResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommentForControlRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommentForControlRequest.class, new TypeReference<CreateCommentForControlRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommentForControlRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.CreateCommentForControlResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.CreateCommentForControlResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.CreateCommentForControlResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.CreateCommentForControlResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AuditControlComment>() {})
                            .thenApply(res::withAuditControlComment);
                } else {
