...
public class GetInformationRequestTestSnapshotEvidenceDetail {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetInformationRequestTestSnapshotEvidenceDetailRequest, GetInformationRequestTestSnapshotEvidenceDetailResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetInformationRequestTestSnapshotEvidenceDetailRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInformationRequestTestSnapshotEvidenceDetailRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetInformationRequestTestSnapshotEvidenceDetailRequest request) {
        ...
        @Override
        public GetInformationRequestTestSnapshotEvidenceDetailResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetInformationRequestTestSnapshotEvidenceDetailResponse.Builder resBuilder =
                    GetInformationRequestTestSnapshotEvidenceDetailResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetInformationRequestTestSnapshotEvidenceDetailResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withVantaTestSnapshotEvidenceDetail(Utils.unmarshal(response, new TypeReference<VantaTestSnapshotEvidenceDetail>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetInformationRequestTestSnapshotEvidenceDetailRequest, com.vanta.vanta_auditor_api.models.operations.async.GetInformationRequestTestSnapshotEvidenceDetailResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetInformationRequestTestSnapshotEvidenceDetailRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInformationRequestTestSnapshotEvidenceDetailRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetInformationRequestTestSnapshotEvidenceDetailRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.GetInformationRequestTestSnapshotEvidenceDetailResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.GetInformationRequestTestSnapshotEvidenceDetailResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.GetInformationRequestTestSnapshotEvidenceDetailResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.GetInformationRequestTestSnapshotEvidenceDetailResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<VantaTestSnapshotEvidenceDetail>() {})
                            .thenApply(res::withVantaTestSnapshotEvidenceDetail);
                } else {
