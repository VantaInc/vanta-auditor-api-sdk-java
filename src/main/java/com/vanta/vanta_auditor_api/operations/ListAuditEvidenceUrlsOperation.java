...
public class ListAuditEvidenceUrlsOperation implements RequestOperation<ListAuditEvidenceUrlsRequest, ListAuditEvidenceUrlsResponse> {
    ...
    public ListAuditEvidenceUrlsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAuditEvidenceUrlsRequest request) throws Exception {
