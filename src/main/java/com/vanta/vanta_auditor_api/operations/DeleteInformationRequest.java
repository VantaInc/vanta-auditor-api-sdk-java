...
public class DeleteInformationRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteInformationRequestRequest, DeleteInformationRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteInformationRequestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteInformationRequestRequest request) {
        ...
        @Override
        public DeleteInformationRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteInformationRequestResponse.Builder resBuilder =
            ...
            DeleteInformationRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteInformationRequestRequest, com.vanta.vanta_auditor_api.models.operations.async.DeleteInformationRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteInformationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteInformationRequestRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteInformationRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.DeleteInformationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.DeleteInformationRequestResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.DeleteInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.DeleteInformationRequestResponse res = resBuilder.build();
