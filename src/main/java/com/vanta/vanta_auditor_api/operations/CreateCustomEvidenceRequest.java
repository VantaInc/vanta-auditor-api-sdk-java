...
public class CreateCustomEvidenceRequest {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCustomEvidenceRequestRequest request) throws Exception {
        ...
        @Override
        public CreateCustomEvidenceRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CustomEvidenceRequest out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCustomEvidenceRequest(out);
                    return res;
                } else {
