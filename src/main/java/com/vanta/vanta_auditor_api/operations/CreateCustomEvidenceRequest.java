...
public class CreateCustomEvidenceRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCustomEvidenceRequestRequest, CreateCustomEvidenceRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCustomEvidenceRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCustomEvidenceRequestRequest.class, new TypeReference<CreateCustomEvidenceRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCustomEvidenceRequestRequest request) {
        ...
        @Override
        public CreateCustomEvidenceRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCustomEvidenceRequestResponse.Builder resBuilder =
            ...
            CreateCustomEvidenceRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCustomEvidenceRequest(Utils.unmarshal(response, new TypeReference<CustomEvidenceRequest>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCustomEvidenceRequestRequest, com.vanta.vanta_auditor_api.models.operations.async.CreateCustomEvidenceRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCustomEvidenceRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCustomEvidenceRequestRequest.class, new TypeReference<CreateCustomEvidenceRequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCustomEvidenceRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.CreateCustomEvidenceRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.CreateCustomEvidenceRequestResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.CreateCustomEvidenceRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.CreateCustomEvidenceRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CustomEvidenceRequest>() {})
                            .thenApply(res::withCustomEvidenceRequest);
                } else {
