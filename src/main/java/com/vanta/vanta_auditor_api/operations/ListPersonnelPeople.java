...
public class ListPersonnelPeople {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPersonnelPeopleRequest, ListPersonnelPeopleResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPersonnelPeopleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPersonnelPeopleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPersonnelPeopleRequest request) {
        ...
        @Override
        public ListPersonnelPeopleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPersonnelPeopleResponse.Builder resBuilder =
                    ListPersonnelPeopleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListPersonnelPeopleResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponsePersonnelPerson(Utils.unmarshal(response, new TypeReference<PaginatedResponsePersonnelPerson>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPersonnelPeopleRequest, com.vanta.vanta_auditor_api.models.operations.async.ListPersonnelPeopleResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPersonnelPeopleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPersonnelPeopleRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPersonnelPeopleRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListPersonnelPeopleResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListPersonnelPeopleResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListPersonnelPeopleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListPersonnelPeopleResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponsePersonnelPerson>() {})
                            .thenApply(res::withPaginatedResponsePersonnelPerson);
                } else {
