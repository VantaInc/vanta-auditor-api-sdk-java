...
public class ListAuditControls {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAuditControlsRequest, ListAuditControlsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAuditControlsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAuditControlsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAuditControlsRequest request) {
        ...
        @Override
        public ListAuditControlsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedResponseAuditorControl(Utils.unmarshal(response, new TypeReference<PaginatedResponseAuditorControl>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAuditControlsRequest, com.vanta.vanta_auditor_api.models.operations.async.ListAuditControlsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAuditControlsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAuditControlsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAuditControlsRequest request) {
        ...
        @Override
        public CompletableFuture<com.vanta.vanta_auditor_api.models.operations.async.ListAuditControlsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.vanta.vanta_auditor_api.models.operations.async.ListAuditControlsResponse.Builder resBuilder =
                    com.vanta.vanta_auditor_api.models.operations.async.ListAuditControlsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.vanta.vanta_auditor_api.models.operations.async.ListAuditControlsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedResponseAuditorControl>() {})
                            .thenApply(res::withPaginatedResponseAuditorControl);
                } else {
