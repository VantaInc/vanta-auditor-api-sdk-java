 ...
 * Trainings
 * 
 * <p>Security training task details, or null if not available.
...
public class Trainings {
     ...
     * Security task status for individual task categories.
     */
    public Trainings withStatus(PeopleSecurityTaskStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Due date for incomplete task in ISO 8601 format, or null if none.
     */
    public Trainings withDueDate(String dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
     ...
     * Due date for incomplete task in ISO 8601 format, or null if none.
     */
    public Trainings withDueDate(Optional<String> dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
        this.dueDate = dueDate;
        return this;
    }
     ...
     * Completion date for completed task in ISO 8601 format, or null if incomplete.
     */
    public Trainings withCompletionDate(String completionDate) {
        Utils.checkNotNull(completionDate, "completionDate");
     ...
     * Completion date for completed task in ISO 8601 format, or null if incomplete.
     */
    public Trainings withCompletionDate(Optional<String> completionDate) {
        Utils.checkNotNull(completionDate, "completionDate");
        this.completionDate = completionDate;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Trainings.class,
                "status", status,
                "dueDate", dueDate,
