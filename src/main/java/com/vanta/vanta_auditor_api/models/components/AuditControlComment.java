 ...
 * AuditControlComment
 * 
 * <p>A comment on a control within an audit. These threaded discussions let
 ...
 * being assessed.
 * 
 * <p>Audit control comments are scoped to a single audit engagement and are
 * distinct from any organization-internal control comments.
 */
public class AuditControlComment {
    /**
     ...
     * Format: ObjectId as a string (e.g., "6890e473dce1da5d8406f5e7").
     */
    public AuditControlComment withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Can include explanations, questions, or clarifications about the control.
     */
    public AuditControlComment withText(String text) {
        Utils.checkNotNull(text, "text");
        this.text = text;
        return this;
    }
     ...
     * Format: ISO 8601 UTC timestamp.
     */
    public AuditControlComment withCreationDate(OffsetDateTime creationDate) {
        Utils.checkNotNull(creationDate, "creationDate");
        this.creationDate = creationDate;
        return this;
    }
     ...
     * Format: ISO 8601 UTC timestamp.
     */
    public AuditControlComment withModificationDate(OffsetDateTime modificationDate) {
        Utils.checkNotNull(modificationDate, "modificationDate");
     ...
     * Format: ISO 8601 UTC timestamp.
     */
    public AuditControlComment withModificationDate(Optional<OffsetDateTime> modificationDate) {
        Utils.checkNotNull(modificationDate, "modificationDate");
        this.modificationDate = modificationDate;
        return this;
    }
     ...
     * Format: ISO 8601 UTC timestamp.
     */
    public AuditControlComment withDeletionDate(OffsetDateTime deletionDate) {
        Utils.checkNotNull(deletionDate, "deletionDate");
     ...
     * Format: ISO 8601 UTC timestamp.
     */
    public AuditControlComment withDeletionDate(Optional<OffsetDateTime> deletionDate) {
        Utils.checkNotNull(deletionDate, "deletionDate");
        this.deletionDate = deletionDate;
        return this;
    }
     ...
     * Null when the comment author can't be matched to a Vanta user.
     */
    public AuditControlComment withEmail(String email) {
        Utils.checkNotNull(email, "email");
     ...
     * Null when the comment author can't be matched to a Vanta user.
     */
    public AuditControlComment withEmail(Optional<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * be reliably matched across systems by email alone.
     */
    public AuditControlComment withAuthorName(String authorName) {
        Utils.checkNotNull(authorName, "authorName");
     ...
     * be reliably matched across systems by email alone.
     */
    public AuditControlComment withAuthorName(Optional<String> authorName) {
        Utils.checkNotNull(authorName, "authorName");
        this.authorName = authorName;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuditControlComment other = (AuditControlComment) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuditControlComment.class,
                "id", id,
                "text", text,
    ...
    public final static class Builder {
        ...
        public AuditControlComment build() {

            return new AuditControlComment(
                id, text, creationDate,
                modificationDate, deletionDate, email,
                authorName);
        }
