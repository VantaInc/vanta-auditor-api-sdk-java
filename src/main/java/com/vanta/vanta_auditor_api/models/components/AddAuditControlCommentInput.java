 ...
 * 
 * <p>Comments enable auditors and customers to collaborate on a control within an
 * audit. All comments are immediately visible to authorized parties once created.
 */
public class AddAuditControlCommentInput {
    /**
    ...
    @JsonCreator
    public AddAuditControlCommentInput(
     ...
     * or explanations related to the control.
     */
    public AddAuditControlCommentInput withText(String text) {
        Utils.checkNotNull(text, "text");
        this.text = text;
        return this;
    }
     ...
     * This email uniquely identifies the author across systems.
     */
    public AddAuditControlCommentInput withEmail(String email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * Format: ISO 8601 UTC timestamp.
     */
    public AddAuditControlCommentInput withCreationDate(OffsetDateTime creationDate) {
        Utils.checkNotNull(creationDate, "creationDate");
        this.creationDate = creationDate;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddAuditControlCommentInput other = (AddAuditControlCommentInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AddAuditControlCommentInput.class,
                "text", text,
                "email", email,
    ...
    public final static class Builder {
        ...
        public AddAuditControlCommentInput build() {

            return new AddAuditControlCommentInput(
                text, email, creationDate);
        }
