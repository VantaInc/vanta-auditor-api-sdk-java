...
public class CustomEvidenceRequest {
     ...
     * Internal id of the custom evidence request within Vanta
     */
    public CustomEvidenceRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * A set of controls, referenced by id, to map the evidence to
     */
    public CustomEvidenceRequest withControlIds(List<String> controlIds) {
        Utils.checkNotNull(controlIds, "controlIds");
        this.controlIds = controlIds;
        return this;
    }
     ...
     * Title for the evidence request
     */
    public CustomEvidenceRequest withTitle(String title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * Description for the evidence request
     */
    public CustomEvidenceRequest withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }

    public CustomEvidenceRequest withCadence(RecurrenceDuration cadence) {
        Utils.checkNotNull(cadence, "cadence");
        this.cadence = cadence;
        return this;
    }

    public CustomEvidenceRequest withReminderWindow(RecurrenceDuration reminderWindow) {
        Utils.checkNotNull(reminderWindow, "reminderWindow");
        this.reminderWindow = reminderWindow;
        return this;
    }
     ...
     * Whether this document contains sensitive data and needs more restrictive read access
     */
    public CustomEvidenceRequest withIsRestricted(boolean isRestricted) {
        Utils.checkNotNull(isRestricted, "isRestricted");
        this.isRestricted = isRestricted;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(CustomEvidenceRequest.class,
                "id", id,
