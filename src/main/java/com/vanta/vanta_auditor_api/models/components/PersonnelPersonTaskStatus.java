 ...
 */
public class PersonnelPersonTaskStatus {
    /**
    ...
    @JsonCreator
    public PersonnelPersonTaskStatus(
     ...
     * Overall user task status.
     */
    public PersonnelPersonTaskStatus withStatus(PeopleTaskStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Due date for the earliest incomplete task in ISO 8601 format, or null if none.
     */
    public PersonnelPersonTaskStatus withDueDate(String dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
     ...
     * Due date for the earliest incomplete task in ISO 8601 format, or null if none.
     */
    public PersonnelPersonTaskStatus withDueDate(Optional<String> dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
        this.dueDate = dueDate;
        return this;
    }
     ...
     * Completion date when all tasks are complete in ISO 8601 format, or null if incomplete.
     */
    public PersonnelPersonTaskStatus withCompletionDate(String completionDate) {
        Utils.checkNotNull(completionDate, "completionDate");
     ...
     * Completion date when all tasks are complete in ISO 8601 format, or null if incomplete.
     */
    public PersonnelPersonTaskStatus withCompletionDate(Optional<String> completionDate) {
        Utils.checkNotNull(completionDate, "completionDate");
        this.completionDate = completionDate;
        return this;
    }
     ...
     * Count of completed tasks, or null if not available.
     */
    public PersonnelPersonTaskStatus withNumTasksCompleted(double numTasksCompleted) {
        Utils.checkNotNull(numTasksCompleted, "numTasksCompleted");
     ...
     * Count of completed tasks, or null if not available.
     */
    public PersonnelPersonTaskStatus withNumTasksCompleted(Optional<Double> numTasksCompleted) {
        Utils.checkNotNull(numTasksCompleted, "numTasksCompleted");
        this.numTasksCompleted = numTasksCompleted;
        return this;
    }
     ...
     * Count of overdue tasks, or null if not available.
     */
    public PersonnelPersonTaskStatus withNumTasksOverdue(double numTasksOverdue) {
        Utils.checkNotNull(numTasksOverdue, "numTasksOverdue");
     ...
     * Count of overdue tasks, or null if not available.
     */
    public PersonnelPersonTaskStatus withNumTasksOverdue(Optional<Double> numTasksOverdue) {
        Utils.checkNotNull(numTasksOverdue, "numTasksOverdue");
        this.numTasksOverdue = numTasksOverdue;
        return this;
    }
     ...
     * Count of tasks due soon, or null if not available.
     */
    public PersonnelPersonTaskStatus withNumTasksDueSoon(double numTasksDueSoon) {
        Utils.checkNotNull(numTasksDueSoon, "numTasksDueSoon");
     ...
     * Count of tasks due soon, or null if not available.
     */
    public PersonnelPersonTaskStatus withNumTasksDueSoon(Optional<Double> numTasksDueSoon) {
        Utils.checkNotNull(numTasksDueSoon, "numTasksDueSoon");
        this.numTasksDueSoon = numTasksDueSoon;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PersonnelPersonTaskStatus other = (PersonnelPersonTaskStatus) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PersonnelPersonTaskStatus.class,
                "status", status,
                "dueDate", dueDate,
    ...
    public final static class Builder {
        ...
        public PersonnelPersonTaskStatus build() {

            return new PersonnelPersonTaskStatus(
                status, dueDate, completionDate,
                numTasksCompleted, numTasksOverdue, numTasksDueSoon);
        }
