 ...
 * DeviceMonitoring
 * 
 * <p>Device monitoring task details, or null if not available.
...
public class DeviceMonitoring {
     ...
     * Security task status for individual task categories.
     */
    public DeviceMonitoring withStatus(PeopleSecurityTaskStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Due date for incomplete task in ISO 8601 format, or null if none.
     */
    public DeviceMonitoring withDueDate(String dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
     ...
     * Due date for incomplete task in ISO 8601 format, or null if none.
     */
    public DeviceMonitoring withDueDate(Optional<String> dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
        this.dueDate = dueDate;
        return this;
    }
     ...
     * Completion date for completed task in ISO 8601 format, or null if incomplete.
     */
    public DeviceMonitoring withCompletionDate(String completionDate) {
        Utils.checkNotNull(completionDate, "completionDate");
     ...
     * Completion date for completed task in ISO 8601 format, or null if incomplete.
     */
    public DeviceMonitoring withCompletionDate(Optional<String> completionDate) {
        Utils.checkNotNull(completionDate, "completionDate");
        this.completionDate = completionDate;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeviceMonitoring other = (DeviceMonitoring) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeviceMonitoring.class,
                "status", status,
                "dueDate", dueDate,
