...
public enum AuditIntegrationServiceCategory {
    ...
    AuditIntegrationServiceCategory(String value) {
        this.value = value;
    }
    ...
    public static Optional<AuditIntegrationServiceCategory> fromValue(String value) {
        for (AuditIntegrationServiceCategory o: AuditIntegrationServiceCategory.values()) {
