 ...
 * BackgroundChecks
 * 
 * <p>Background check task details, or null if not available.
...
public class BackgroundChecks {
     ...
     * Security task status for individual task categories.
     */
    public BackgroundChecks withStatus(PeopleSecurityTaskStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Due date for incomplete task in ISO 8601 format, or null if none.
     */
    public BackgroundChecks withDueDate(String dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
     ...
     * Due date for incomplete task in ISO 8601 format, or null if none.
     */
    public BackgroundChecks withDueDate(Optional<String> dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
        this.dueDate = dueDate;
        return this;
    }
     ...
     * Completion date for completed task in ISO 8601 format, or null if incomplete.
     */
    public BackgroundChecks withCompletionDate(String completionDate) {
        Utils.checkNotNull(completionDate, "completionDate");
     ...
     * Completion date for completed task in ISO 8601 format, or null if incomplete.
     */
    public BackgroundChecks withCompletionDate(Optional<String> completionDate) {
        Utils.checkNotNull(completionDate, "completionDate");
        this.completionDate = completionDate;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BackgroundChecks other = (BackgroundChecks) o;
        return 
    ...
    public String toString() {
        return Utils.toString(BackgroundChecks.class,
                "status", status,
                "dueDate", dueDate,
    ...
    public final static class Builder {
        ...
        public BackgroundChecks build() {

            return new BackgroundChecks(
                status, dueDate, completionDate);
        }
