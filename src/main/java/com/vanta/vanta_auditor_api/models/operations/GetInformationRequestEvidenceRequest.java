...
public class GetInformationRequestEvidenceRequest {
    ...
    @JsonCreator
    public GetInformationRequestEvidenceRequest(
            String auditId,
            String requestId,
            String evidenceId) {
    ...
    public GetInformationRequestEvidenceRequest withAuditId(String auditId) {
        Utils.checkNotNull(auditId, "auditId");
        this.auditId = auditId;
        return this;
    }

    public GetInformationRequestEvidenceRequest withRequestId(String requestId) {
        Utils.checkNotNull(requestId, "requestId");
        this.requestId = requestId;
        return this;
    }

    public GetInformationRequestEvidenceRequest withEvidenceId(String evidenceId) {
        Utils.checkNotNull(evidenceId, "evidenceId");
        this.evidenceId = evidenceId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetInformationRequestEvidenceRequest other = (GetInformationRequestEvidenceRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetInformationRequestEvidenceRequest.class,
                "auditId", auditId,
                "requestId", requestId,
    ...
    public final static class Builder {
        ...
        public GetInformationRequestEvidenceRequest build() {

            return new GetInformationRequestEvidenceRequest(
                auditId, requestId, evidenceId);
        }
