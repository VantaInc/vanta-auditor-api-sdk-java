...
public class ListAccountAccessServicesRequest {
    /**
     * The audit ID
     */
    ...
    @JsonCreator
    public ListAccountAccessServicesRequest(
            String auditId,
     ...
     * The audit ID
     */
    public ListAccountAccessServicesRequest withAuditId(String auditId) {
        Utils.checkNotNull(auditId, "auditId");
        this.auditId = auditId;
        return this;
    }
     ...
     * Maximum number of results per page (1-100, default 10)
     */
    public ListAccountAccessServicesRequest withPageSize(int pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * Maximum number of results per page (1-100, default 10)
     */
    public ListAccountAccessServicesRequest withPageSize(Optional<Integer> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * Pagination cursor from previous response
     */
    public ListAccountAccessServicesRequest withPageCursor(String pageCursor) {
        Utils.checkNotNull(pageCursor, "pageCursor");
     ...
     * Pagination cursor from previous response
     */
    public ListAccountAccessServicesRequest withPageCursor(Optional<String> pageCursor) {
        Utils.checkNotNull(pageCursor, "pageCursor");
        this.pageCursor = pageCursor;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAccountAccessServicesRequest other = (ListAccountAccessServicesRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListAccountAccessServicesRequest.class,
                "auditId", auditId,
                "pageSize", pageSize,
    ...
    public final static class Builder {
        ...
        public ListAccountAccessServicesRequest build() {
            if (pageSize == null) {
                pageSize = _SINGLETON_VALUE_PageSize.value();
            }

            return new ListAccountAccessServicesRequest(
                auditId, pageSize, pageCursor);
        }
