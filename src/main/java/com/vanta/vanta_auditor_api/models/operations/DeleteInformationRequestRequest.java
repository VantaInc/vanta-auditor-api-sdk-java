...
public class DeleteInformationRequestRequest {
    ...
    @JsonCreator
    public DeleteInformationRequestRequest(
            String auditId,
            String requestId) {
    ...
    public DeleteInformationRequestRequest withAuditId(String auditId) {
        Utils.checkNotNull(auditId, "auditId");
        this.auditId = auditId;
        return this;
    }

    public DeleteInformationRequestRequest withRequestId(String requestId) {
        Utils.checkNotNull(requestId, "requestId");
        this.requestId = requestId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteInformationRequestRequest other = (DeleteInformationRequestRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteInformationRequestRequest.class,
                "auditId", auditId,
                "requestId", requestId);
    }
    ...
    public final static class Builder {
        ...
        public DeleteInformationRequestRequest build() {

            return new DeleteInformationRequestRequest(
                auditId, requestId);
        }
