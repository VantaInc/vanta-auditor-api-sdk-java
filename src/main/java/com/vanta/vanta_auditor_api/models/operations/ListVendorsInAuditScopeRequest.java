...
public class ListVendorsInAuditScopeRequest {
    ...
    @JsonCreator
    public ListVendorsInAuditScopeRequest(
            String auditId,
    ...
    public ListVendorsInAuditScopeRequest withAuditId(String auditId) {
        Utils.checkNotNull(auditId, "auditId");
        this.auditId = auditId;
        return this;
    }

    public ListVendorsInAuditScopeRequest withPageSize(int pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
    ...
    public ListVendorsInAuditScopeRequest withPageSize(Optional<Integer> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }

    public ListVendorsInAuditScopeRequest withPageCursor(String pageCursor) {
        Utils.checkNotNull(pageCursor, "pageCursor");
    ...
    public ListVendorsInAuditScopeRequest withPageCursor(Optional<String> pageCursor) {
        Utils.checkNotNull(pageCursor, "pageCursor");
        this.pageCursor = pageCursor;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListVendorsInAuditScopeRequest other = (ListVendorsInAuditScopeRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListVendorsInAuditScopeRequest.class,
                "auditId", auditId,
                "pageSize", pageSize,
    ...
    public final static class Builder {
        ...
        public ListVendorsInAuditScopeRequest build() {
            if (pageSize == null) {
                pageSize = _SINGLETON_VALUE_PageSize.value();
            }

            return new ListVendorsInAuditScopeRequest(
                auditId, pageSize, pageCursor);
        }
