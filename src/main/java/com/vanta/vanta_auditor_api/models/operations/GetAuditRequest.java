...
public class GetAuditRequest {
    ...
    public GetAuditRequest withAuditId(String auditId) {
        Utils.checkNotNull(auditId, "auditId");
        this.auditId = auditId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetAuditRequest other = (GetAuditRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetAuditRequest.class,
                "auditId", auditId);
    }
    ...
    public final static class Builder {
        ...
        public GetAuditRequest build() {

            return new GetAuditRequest(
                auditId);
        }
